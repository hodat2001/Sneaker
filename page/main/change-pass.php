<?php
	if(isset($_POST['doimatkhau'])){
		...
		$sql = "SELECT * FROM tbl_dangky WHERE taikhoan='".$taikhoan."' AND matkhau='".$matkhau_cu."' LIMIT 1";
...
<div class="header-main">
			...
			<div class="input-pass">
                ...
                <input onclick="" id="password" type="password" name="password_cu" placeholder="Mật khẩu" required>
                <div id="eye">
            ...
            <div class="input-pass">
                <i style="color:deepskyblue;margin-right:6px" class="fa-solid fa-lock"></i>
                <input onclick="" id="password" type="password" name="password_moi" placeholder="Nhập lại mật khẩu" required>
