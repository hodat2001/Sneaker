               ...
               <div class="menu">
                    ...
                    <ul class="sub-menu" >
                        ...
                        <li><a href="">Danh mục</a>
                            <ul class="list-menu" style="box-sizing: border-box;">
                            <?php
$sql_danhmuc = "SELECT * FROM tbl_danhmuc ORDER BY id_danhmuc DESC";
$query_danhmuc = mysqli_query($mysqli,$sql_danhmuc);
while($row = mysqli_fetch_array($query_danhmuc)){
?><li><a href="home-category.php?quanly=danhmucsanpham&id=<?php echo $row['id_danhmuc'] ?>"><img src="admin/modules/quanlydanhmucsp/uploads/<?php echo $row['logo'] ?> " style="width:43px;height:41px;margin-right: 12px;padding-top: 15px;position:relative;top:5px"><?php echo $row['tendanhmuc'] ?></a></li>
...
?>
               ...
               <div class="user">
                    <a style="color: deepskyblue;margin-right:3px" href="#"><i class="fa-solid fa-cart-shopping"></i></a>
                    <?php
                                     $t=0;
                                ...
                                ?>
                    <a href="index-home.php?quanly=giohang" style="margin-right: 20px;">Giỏ Hàng(<?php echo$t;?>)</a>
